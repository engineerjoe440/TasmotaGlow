<img src="./TasmotaGlow.png" width="250" alt="logo" align="right"/>

# TasmotaGlow

*ESP-01S based controller built with Tasmota firmware in mind for shadow box lights.*

## BOM

| **Component ID** | **Description** | **Link** |
|------------------|-----------------|----------|
